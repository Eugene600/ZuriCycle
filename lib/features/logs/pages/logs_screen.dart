  ...
  final List<Map<String, dynamic>> categories = [
    ...
    },
    {
      ...
      "entries": [
        ...
        {"name": "Confident", "icon": Icons.emoji_events, "value": "confident"},
    ...
    },
    {
      ...
      "entries": [
        ...
        {"name": "Medium", "icon": Icons.invert_colors_off, "value": "medium"},
        {
          "name": "Heavy",
  ...
  void updateDate(int days) {
    setState(() {
      ...
      ref
          ...
          .getLogs(categories, formattedDate);
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                            "Something wrong has happened. Don't worry, we are working on it."),
